...
btn.addEventListener('click', function() {
    ...
    if (avalaibleMeal && avalaibleDrink) {
        ...
        selectedMeal.innerHTML = `Sorry ${username}! We don't have ${userDrink} Please choose a drink from our Drink menu: ${drinks.join(', ')} and a Protien From our Protien Menu: ${protien.join(', ')}.`;
    ...
    //     selectedMeal.innerHTML = ` sorry ${username}! we dont have ${userDrink}, Please Choose a Drink from our Drink  menu: ${drinks.join(', ')}`
    //     q3.value = '';  
